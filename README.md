...
## Upload packages to server
    ...
    $ conan upload boost/1.60.0@lucteo/stable --all
    
## Reuse the packages

### Basic setup

    $ conan install boost/1.60.0@lucteo/stable
